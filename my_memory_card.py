...
question_list.append(Question('Какого цвета нет на флаге России?', 'Зелёный', 'Крассный', 'Белый', 'Синий'))
...
RadioGroupBox = QGroupBox("Варианты ответветов")
...
def check_answer():
    ...
    if answer[0].isChecked():
        ...
        window.score += 1 
        print('Статистика/n-Всего вопросов:',window.total, '/n-Правельных ответов:',window.score)
